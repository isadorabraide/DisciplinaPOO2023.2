...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Insira o código do estado de origem da carga do caminhão (1 à 5):");
		cod_est=sc.nextInt();
		if(cod_est < 1 && cod_est >5) {
			System.out.println("Código inválido.");
		}
		
		System.out.println("Insira o código de carga(entre 10 e 40):");
		cod_carga=sc.nextInt();
		if(cod_carga <10 && cod_carga>40) {
			System.out.println("Código inválido.");
		}
		
		System.out.println("Insira o peso da carga do caminhão em toneladas;");
		...
		if(cod_carga >= 10 && cod_carga <= 20) {
			...
			System.out.println("O preço da carga do caminhão é de " +pre_carga+ "reais.");
		...
		System.out.println("Valor total transportado pelo caminhão :" +valor_total+ " reais.");
