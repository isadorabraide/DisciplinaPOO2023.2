	...
	public static void main(String[] args) {
		...
		if(I==1) {
			if(A<B && A<C) {
				...
				if(A<C) {System.out.println("A ordem crescente dos números: " +B+ "-" +A+ "-" +C);
				}else {System.out.println("A ordem crescente dos números: " +B+ "-" +C+ "-" +A);}
			
			}
			
			else if (C<A && C<B) {
				if(A<B) { System.out.println("A ordem crescente dos números: " +C+ "-" +A+ "-" +B);
